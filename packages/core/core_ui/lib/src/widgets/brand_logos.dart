...
// Note: there is deliberately no embedded Apple logo here. Apple's "Sign in
// with Apple" guidelines require their own downloaded artwork; we render the
// sanctioned `SignInWithAppleButton` from feature_auth instead of a recreation.
